...
public class FrescoHierarchyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fresco_hierarchy);
        initView();
    }
    ...
    private void initView() {
        ...
        GenericDraweeHierarchy hierarchy = new GenericDraweeHierarchyBuilder(getResources())
                ...
                //设置占位图及它的缩放类型
                .setPlaceholderImage(ContextCompat.getDrawable(this, R.drawable.icon_placeholder), ScalingUtils.ScaleType.FOCUS_CROP)
                //设置正在加载图及其缩放类型
                .setProgressBarImage(ContextCompat.getDrawable(this, R.drawable.icon_progress_bar), ScalingUtils.ScaleType.FOCUS_CROP)
                //设置失败图及其缩放类型
                .setFailureImage(ContextCompat.getDrawable(this, R.drawable.icon_failure), ScalingUtils.ScaleType.FOCUS_CROP)
                //设置重试图及其缩放类型
                .setRetryImage(ContextCompat.getDrawable(this, R.drawable.icon_retry), ScalingUtils.ScaleType.FOCUS_CROP)
                //构建
                .build();
