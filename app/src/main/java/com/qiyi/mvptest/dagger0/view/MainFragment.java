...
import com.qiyi.mvptest.dagger0.MultiConstruct;
import com.qiyi.mvptest.dagger0.ToastUtil;
import com.qiyi.mvptest.dagger0.di.components.MainFragmentComponent;
...
public class MainFragment extends BaseFragment implements MainPresenter.IUserView{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(getActivity() instanceof Dagger0MainActivity){
            mainFragmentComponent = ((Dagger0MainActivity)getActivity() ).getMainComponent().mainFragmentComponent();
